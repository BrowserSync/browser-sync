...
module.exports = {
    ...
    initServer: function (host, port, baseDir) {
        ...
        var templates = [
            "{green:Local URL:    }{magenta:{:local:}}",
            "{green:External URL: }{magenta:{:remote:}}\n"
        ];
     ...
     * @returns {String}
     */
    initProxy: function (host, port, proxyUrl) {

        var output = "";

        var templates = [
            "{green:Proxying:} {magenta:{:proxy:}}\n",
            "{green:BrowserSync Local URL:}    {magenta:{:local:}}",
            "{green:BrowserSync External URL:} {magenta:{:remote:}}\n"
        ];
