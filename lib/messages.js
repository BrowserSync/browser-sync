...
var messages = {
    ...
    proxyError: function (code) {
        if (code === "ENOTFOUND") {
            return messages.configError("Proxy address not reachable. Is your server running?");
        } else {
            return messages.configError("There was an issue with the proxy, code: " + code);
        }
    },
