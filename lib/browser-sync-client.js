...
//            if (ghostMode.clickedLinks && !ghostMode.links) {
...
//            }
    ...
    var ghost = {
        ...
        initClickEvents: function (scope, utils, callback) {
            ...
            body[utils.eventListener](utils.prefix + "click", function (e) {

                if (scope.ghostMode.enabled && !fromSocket) {

                    var elem = e.target || e.srcElement;
                    var tagName = elem.tagName;
                    var allElems = document.getElementsByTagName(tagName);
                    var i = Array.prototype.indexOf.call(allElems, elem);
        ...
        listeners: {
            ...
            click: function (event) {
                var thisElem = this;
                var data = {
                    url: ghost.getHref(event.target || event.srcElement, thisElem)
                };
...
//        console.log("received: number of elems found: " + elems.length);
...
//        var canceled = !elem.dispatchEvent(event);
//
//        if (canceled) {
...
//    }
    ...
    function simulateClick(elem, evt) {
...
//            var canceled = !elem.dispatchEvent(event);
//
//            console.log("Click event fired in modern browsers");
//
//        } else {
            ...
            if (document.createEvent) {
                ...
                console.log("document.createEvent & MouseEvents not supported");
            }
