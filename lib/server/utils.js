...
var utils = {
     ...
     * @returns {Function}
     */
    html5Mode: function (baseDir, indexFile) {
        indexFile = indexFile || "index.html";
        var path;
        if (isList(baseDir)) {
            for (var i = 0; i < baseDir.size; i++) {
                var innerPath = filePath.resolve(process.cwd(), baseDir.get(i), indexFile);
            ...
            path = filePath.resolve(process.cwd(), baseDir, indexFile);
        }
