 ...
 *
 */
module.exports.plugin = function (bs, scripts, cb) {
...
module.exports.createServer = function (options, scripts, bs) {
    ...
    if (options.proxy) {
        return createProxy(options, scripts, bs);
    }
 ...
 * @param {BrowserSync} bs
 */
function createProxy(options, scripts, bs) {

    checkProxyTarget(options.proxy, function (err) {
        if (err) {
