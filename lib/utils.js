...
var utils = {
    ...
    getClientJs: function (port, options) {
        var js;
        var path1 = "/../node_modules/socket.io-client/dist/socket.io.min.js";
        var path2 = "/../node_modules/socket.io/node_modules/socket.io-client/dist/socket.io.min.js";
        try {
            js = fs.readFileSync(filePath.resolve(__dirname + path1), "utf-8") + ";";
        } catch (e) {
            try {
                js = fs.readFileSync(filePath.resolve(__dirname + path2), "utf-8") + ";";
            } catch (e) {
