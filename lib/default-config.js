...
module.exports = {
    ...
    /**
     * For use with the server ONLY, enable https
     * @property https
     * @type Boolean
     * @default undefined
     */
    ...
    /**
     * Decide which URL to open automatically when BrowserSycn starts, or choose none.
    ...
    browser: "default",
    /**
     * Requires an internet connection - usefull for services such as [Typekit](https://typekit.com/)
