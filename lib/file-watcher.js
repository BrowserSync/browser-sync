...
module.exports = {
     ...
     * @returns {Function}
     */
    getChangeCallback: function (callback, io, options, _this, timeout) {
     ...
     * @param {Number} [timeout]
     */
    init: function (changeFile, log, files, io, options, _this, timeout) {

        var watchCallback = this.getWatchCallback(log, options);
        var changeCallback = this.getChangeCallback(changeFile, io, options, _this, timeout);
