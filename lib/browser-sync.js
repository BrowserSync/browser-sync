...
browserSync.prototype = {
    ...
    startServices: function (args) {
        ...
        this.handleSocketConnection(this.callbacks, options, this.handleClientSocketEvent);
        // launch the server

        this.launchServer(this.getHostIp(options, devIp.getIp(null)), ports, options);

        // Watch files
        this.watchFiles(files, iolocal, this.changeFile, options);
    },
    /**
     *
