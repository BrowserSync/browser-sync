    ...
    ghostModeCallbacks: [
        {
            ...
            callback: function (client, data) {
                client.broadcast.to("browser-sync").emit("scroll:update", { position: data.pos, ghostId: data.ghostId, url: data.url});
            }
        },
        {
            name: "input:type",
            callback: function (client, data) {
                client.broadcast.to("browser-sync").emit("input:update", { id: data.id, value: data.value });
            }
        },
        {
            name: "input:select",
        ...
        },
        {
            name: "input:radio",
            callback: function (client, data) {
                client.broadcast.to("browser-sync").emit("input:update:radio", { id: data.id, value: data.value });
            }
        },
        {
            name: "input:checkbox",
            callback: function (client, data) {
                client.broadcast.to("browser-sync").emit("input:update:checkbox", { id: data.id, checked: data.checked });
            }
        },
        {
            name: "form:submit",
            callback: function (client, data) {
                client.broadcast.to("browser-sync").emit("form:submit", { id: data.id });
            }
        },
        {
            name: "form:reset",
        ...
        },
        {
            name: "click",
            callback: function (client, data) {
                client.broadcast.to("browser-sync").emit("click", data);
            }
        }
    ],
    /**
