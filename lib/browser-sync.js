 ...
 * @param {Function} [cb]
 */
BrowserSync.prototype.registerPlugin = function (module, cb) {

    if (!_.isFunction(module.plugin)) {
        return typeof cb === "function" ? cb("Module must implement a .plugin() method") : false;
    }

    this.plugins["plugin:" + module.name || _.uniqueId()] = module;
