...
BrowserSync.prototype = {
    ...
    init: function (files, options, version) {
        ...
        this.getPorts(options).then(function (ports) {
            _this.startServices(ports, files, options);
        }, function (minPorts) {
            _this.fail(messages.ports.invalid(minPorts), options, true);
        });
    ...
    getPorts: function (options) {
        ...
        portScanner.getPorts(3, minPortRange, maxPortRange, names).then(function (ports) {
            deferred.resolve(ports);
        }, function () {
            deferred.reject(minPorts);
        });
    ...
    startServices: function (ports, files, options) {
        ...
        this.handleSocketConnection(callbacks, options);
