...
var info = {
    ...
    makeConfig: function (bs) {
        ...
        var path = bs.cwd + config.userFile;

        fs.writeFile(path, file, function (err, out) {
            logger.info("Config file created {magenta:%s}", utils.resolveRelativeFilePath(path, bs.cwd));
